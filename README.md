About rasterstats-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rasterstats-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3497&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rasterstats-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rasterstats` can be installed with `conda`:
...
```
mamba install rasterstats
```

It is possible to list all of the versions of `rasterstats` available on your platform with `conda`:
...
```
mamba search rasterstats --channel conda-forge
```
...
mamba repoquery search rasterstats --channel conda-forge

# List packages depending on `rasterstats`:
mamba repoquery whoneeds rasterstats --channel conda-forge

# List dependencies of `rasterstats`:
mamba repoquery depends rasterstats --channel conda-forge
```
